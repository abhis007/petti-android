...
export default function CreateQuestion({route, navigation}) {
      ...
      .then(
        (response) => {
          ...
          Notifier.showNotification({
            title: 'DONE',
            description: 'Petti Created successfully',
  ...
  const copyUrl = () => {
    ...
    Notifier.showNotification({
      title: 'Copied',
      description: 'Petti link Copied Sucessffully ',
      Component: NotifierComponents.Alert,
      duration: 3000,
      componentProps: {
        alertType: 'info',
  ...
  React.useEffect(() => {
    AdMobRewarded.setTestDevices([AdMobRewarded.simulatorId]);
      AdMobRewarded.setAdUnitID('ca-app-pub-8661978230190789/6975056678');
      ...
      // AdMobInterstitial.setAdUnitID('ca-app-pub-8661978230190789/6975056678');
          ...
          <View style={{flex: 1, flexDirection: 'row'}}>
            ...
            <View style={{flex: 3}}>
              <Text
                ...
                Create a petti and share the link to get anonymous responses from your friends
              </Text>
            </View>
          </View>
        </View>
            ...
            <Content padder>
              {!sharemode ? (
                <Textarea
                  ...
                  style={{borderRadius: 25, backgroundColor: '#e3f2fd'}}
  ...
  adUnitID="ca-app-pub-8661978230190789~2977931913"
            ...
            <View padder style={{padding: 10}}>
              {!sharemode ? (
                <Button
                  block
                  rounded
                  onPress={() => createQuestionApiCall()}
                  style={{backgroundColor: '#ff5252'}}>
                  <Text>Create petti</Text>
                </Button>
              ) : null}
            </View>
          </Form>
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{flex: 1, padding: 10}}>
              <Button
                ...
                small
                onPress={() => copyUrl()}>
                <Text style={{textAlign: 'center', color: 'white'}}>Copy </Text>
              </Button>
            </View>
            <View style={{flex: 1, padding: 10}}>
              <Button
